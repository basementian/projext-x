...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_offer_records_listing_id'), 'offer_records', ['listing_id'], unique=False)
    op.create_table('profit_records',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('listing_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_profit_records_listing_id'), 'profit_records', ['listing_id'], unique=False)
    ...
    op.create_index(op.f('ix_queue_entries_listing_id'), 'queue_entries', ['listing_id'], unique=False)
    op.create_index(op.f('ix_queue_entries_status'), 'queue_entries', ['status'], unique=False)
    op.create_table('zombie_records',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('listing_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_zombie_records_listing_id'), 'zombie_records', ['listing_id'], unique=False)
